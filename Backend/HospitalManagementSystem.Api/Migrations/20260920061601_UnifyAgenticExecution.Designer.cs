...
namespace HospitalManagementSystem.Api.Migrations
{
    ...
    [Migration("20260920061601_UnifyAgenticExecution")]
    partial class UnifyAgenticExecution
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagementSystem.Api.AgenticAI.HospitalAssistant.AssistantConversation", b =>
                {
                    ...
                    b.Property<Guid>("InitialRequestId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PatientId", "InitialRequestId")
                        .IsUnique();

                    b.ToTable("AssistantConversations");
                });

            modelBuilder.Entity("HospitalManagementSystem.Api.AgenticAI.PlanningCoordinator.AgenticExecution", b =>
                {
            ...
            modelBuilder.Entity("HospitalManagementSystem.Api.Models.AppointmentProposal", b =>
                {
                    ...
                    b.Property<string>("ExecutionWorkflowId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Api.Models.PatientCareAssessment", b =>
                {
                    b.Property<int>("PatientCareAssessmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PatientCareAssessmentId"));

                    b.Property<string>("ClinicalJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("RequestedAppointmentProposal")
                        .HasColumnType("boolean");

                    b.Property<string>("RequestedSpecialty")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasKey("PatientCareAssessmentId");

                    b.HasIndex("PatientId", "CreatedAt");

                    b.ToTable("PatientCareAssessments");
                });
