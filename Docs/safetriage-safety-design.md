...
- The coordinator has a hard seven-step cap and only one clarification cycle. The Gemini extraction tool has a timeout and at most one bounded retry; a failed tool call becomes a recorded fallback rather than an unhandled exception.
